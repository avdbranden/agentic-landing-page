...
export function Solution() {
  ...
  return (
    <SectionWrapper id="solution" className="bg-neutral-50 py-24">
          ...
          {items.map((item, i) => (
            ...
            >
              <div className="flex gap-4">
                <div className="shrink-0 w-8 h-8 rounded-lg bg-neutral-900 flex items-center justify-center mt-0.5">
